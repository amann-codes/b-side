                ...
                <div className="relative backdrop-blur-xl bg-background/70 border border-border/50 p-10 shadow-2xl hover:shadow-primary/10 transition-shadow duration-500">
                    <div className="text-center mb-10">
                        ...
                        <p className="mt-3 text-muted-foreground">
                            Sign in to contribute to the Side B of the music
                        </p>
                    </div>
                    <button
                    ...
                    >
                        ...
                        <span className="absolute inset-0 bg-linear-to-r from-transparent via-white/20 to-transparent translate-x-[-150%] group-hover:translate-x-[150%] transition-transform duration-700 skew-x-12" />
                    </button>
                </div>
            </div>
        </div>
